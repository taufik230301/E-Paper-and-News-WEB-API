        ...
        <div class="main-panel">
          <div class="content-wrapper">
              ...
              <h3 class="page-title">
                ...
                </span> Tambah Berita / Iklan Film </h3>
...
<!--                     <h4 class="card-title">Enter News Details</h4> -->
                    ...
                    <form class="forms-sample" method="post" action="add-news.php" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="txtTitle"><strong>Judul Berita / Iklan Film</strong></label>
                        <input type="text" class="form-control" id="txtTitle" name="txtTitle" placeholder="News Title" value="<?=$_newsTitle;?>" required>
                      </div>
					  <div class="form-group">
						<label for="isFeatured"><strong>Apakah Featured ?</strong></label><p class="alert alert-danger"> Jika Yes maka masuk ke <strong>Featured</strong> di menu App Android.</p>
                        <div class="row" style="margin-left: 5px;">
							<div class="form-check col-1">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="isFeatured" id="isFeatured1" value="1" <?php if($_isFeatured=='1'){echo'checked';}?>> Ya </label>
                              </div>
                            
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="isFeatured" id="isFeatured2" value="0" <?php if($_isFeatured=='0'){echo'checked';}?>> Tidak </label>
                              </div></div>
                              
						  
						</div>
						<div class="form-group">
						<label for="isTrending"><strong>Berita / Film</strong></label>
						<!-- <p class="alert alert-danger"> Jika Yes maka masuk ke <strong>Treading</strong> di menu App Android.</p> -->
                        <div class="row" style="margin-left: 5px;">
                              <div class="form-check col-1">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="isTrending" id="isTrending2" value="1" <?php if($_isTrending=='1'){echo'checked';}?>> Iklan Film </label>
                              </div>
							<div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="isTrending" id="isTrending1" value="0" <?php if($_isTrending=='0'){echo'checked';}?>> Berita </label>
                              </div>
						...
						<div class="form-group">
						<label for="isBreaking"><strong>Apakah Breaking?</strong></label>
						<p class="alert alert-danger"> Jika Yes maka masuk ke <strong>Breaking</strong> di menu App Android.</p>
                        <div class="row" style="margin-left: 5px;">
							<div class="form-check col-1">
                                <label class="form-check-label">
						...
						<div class="form-group">
						<label for="isPublish"><strong>Status?</strong></label><p class="alert alert-danger"> Cuma Berita/Iklan yang di publish yang ada di App Android</p>
                        <div class="row" style="margin-left: 5px;">
							<div class="form-check col-2">
                              ...
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="isPublish" id="isPublish2" value="0" <?php if($_isPublish=='0'){echo'checked';}?>> Tidak di Publish </label>
                              </div></div>
                              
						  
						</div>
                      <div class="form-group">
                        <label for="example-checkbox-list"><strong>Pilih Kategori</strong></label>
						<!-- Build your select: -->
				...
				?></select>
                      ...
                      <div class="form-group" style="clear: both;">
                        <label for="catImage" style="margin-top: 15px"><strong>Foto</strong></label><p class="alert alert-danger"> Saran resolusi terbaik : Images size 600*300.</p>
                      ...
                      <div class="form-group">
                        <label for="summernote"><strong>Dekripsi Berita / Iklan Film</strong></label><!-- <p class="alert alert-danger"> *For Best Presentation use H3, H4 insted of H1, H2 and provide absolute path for Images, do not upload then through editor.</p> -->
