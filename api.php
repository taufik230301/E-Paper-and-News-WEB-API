...
from tbl_news P WHERE featured=1 and isTrending=0 and status=1 ORDER BY P.published_on DESC Limit 5 ;" or die("SELECT Error: ".$DB->error());
...
from tbl_news P WHERE isBreaking=1 and isTrending=0 and status=1 ORDER BY P.published_on DESC Limit 10;" or die("SELECT Error: ".$DB->error());
	...
	$query = "SELECT P.id, P.news_title, P.news_cover_img, P.published_on, P.news_views, P.news_description, P.news_cat, (
		...
		WHERE tnc.category_id=".$_GET['id']." and status=1 and isTrending=0 ORDER BY P.published_on DESC ".$_page.";" or die("SELECT Error: ".$DB->error());
...
from tbl_news P 
INNER JOIN tbl_news_category tnc ON P.id=tnc.news_id
WHERE tnc.category_id IN(".$_GET['id'].") and status=1 and isTrending=0 GROUP BY P.id ORDER BY RAND() LIMIT 5;" or die("SELECT Error: ".$DB->error());
