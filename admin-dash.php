...
$_koran=0;
$query_count ="SELECT COUNT(DISTINCT id) As koran,COUNT(DISTINCT id) FROM tbl_koran";
$count_check = $DB->select($query_count) or die("SELECT Error: ".$DB->error());
if ( count( $count_check ) > 0 ) {
	$_koran=$count_check[0]['koran'];
}
?>
<?php
	
$_user=0;
$query_count ="SELECT COUNT(DISTINCT SrNo) As user,COUNT(DISTINCT SrNo) FROM tbl_user";
$count_check = $DB->select($query_count) or die("SELECT Error: ".$DB->error());
if ( count( $count_check ) > 0 ) {
	$_user=$count_check[0]['user'];
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Beita Terpublish <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?=$_news;?></h2>
                    <h6 class="card-text"><a href="news.php" title="Atur Berita" style="color: #fff;">Atur Berita</a></h6>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Kategori <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?=$_cat;?></h2>
                    <h6 class="card-text"><a href="categories.php" title="Atur Berita" style="color: #fff;">Atur Kategori</a></h6>
                  </div>
                </div>
              </div>
                  <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-warning card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Koran <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?=$_koran;?></h2>
                    <h6 class="card-text"><a href="aturkoran.php" title="Atur Berita" style="color: #fff;">Atur Koran</a></h6>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">User <i class=" mdi mdi-account-multiple mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?=$_user;?></h2>
