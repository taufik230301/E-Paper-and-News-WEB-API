...
$query = "SELECT tc.*, (SELECT COUNT(category_id) FROM tbl_film_category WHERE category_id =tc.cid) AS cat_post FROM tbl_category AS tc" or die("SELECT Error: ".$DB->error());
